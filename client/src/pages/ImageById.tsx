...
const ImageById = () => {
  ...
  if (isError) {
    return (
      <div className="flex h-screen items-center justify-center bg-zinc-950 text-zinc-200 text-sm font-medium border border-zinc-800 p-8">
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white font-sans selection:bg-zinc-800 selection:text-zinc-200">
      <div className="max-w-6xl mx-auto px-8 py-16">
        <header className="mb-16 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          ...
          <div className="flex items-center gap-4">
            <span className="text-[10px] tracking-widest text-zinc-400 border border-zinc-800 px-3 py-1 rounded-full uppercase">
        ...
        <div className="relative group mb-20">
          <div className="absolute -inset-1 bg-gradient-to-b from-zinc-800 to-transparent opacity-20 blur-xl"></div>
          <div className="relative bg-zinc-900/50 border border-zinc-800/50 overflow-hidden flex items-center justify-center p-4 md:p-12">
            <img
              src={data?.data.url}
              alt={data?.data.name || ""}
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 border-t border-zinc-900 pt-12">
          <div className="md:col-span-4 space-y-8">
            <section>
              <h3 className="text-zinc-500 text-[10px] uppercase tracking-[0.2em] mb-6">
                File Specifications
              </h3>
          ...
          <div className="md:col-span-5">
            ...
            <div className="bg-zinc-900/30 p-4 border border-zinc-900 rounded-sm">
