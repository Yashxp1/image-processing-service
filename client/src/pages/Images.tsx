...
const Images = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen border-2 border-dashed border-black/10 m-8 rounded-xl">
        <p className="text-sm text-gray-500 italic">
          No assets found in your gallery.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto p-8">
      <header className="mb-6 border-b border-zinc-700 pb-6 flex justify-between items-end">
        <div>
          <h1 className="text-4xl font-light tracking-tighter uppercase">
            Gallery
          </h1>
          <p className="text-xs mt-2 text-gray-400">
            Manage your uploaded assets and metadata
          </p>
        </div>
        ...
        {images.map((img) => (
          <div key={img.id} className="group flex flex-col space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex px-2 gap-y-2 border-t justify-between border-black/10 pt-3">
                <div>
